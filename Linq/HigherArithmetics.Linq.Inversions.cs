...
namespace HigherArithmetics.Linq {
  ...
  public static partial class EnumerableExtensions {
    ...
    /// Count inversions
    /// </summary>
    public static int InversionsCount<T>(this IEnumerable<T> source, IComparer<T> comparer) {
      if (source is null)
    ...
    /// Count inversions
    /// </summary>
    public static int InversionsCount<T>(this IEnumerable<T> source) where T : IComparable<T> =>
      InversionsCount(source, null);
