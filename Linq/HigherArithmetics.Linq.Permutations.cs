...
namespace HigherArithmetics.Linq {
  ...
  public static partial class EnumerableExtensions {
    ...
    /// <summary>
    /// Enumerate permutation starting from items
    /// </summary>
    ...
    /// </summary>
    /// <param name="items">initial permutation to use</param>
    public static IEnumerable<T[]> Permutations<T>(this IEnumerable<T> items) where T : IComparable<T> =>
      Permutations(items, null);
